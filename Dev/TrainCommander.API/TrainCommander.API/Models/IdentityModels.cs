...
namespace TrainCommander.API.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        public ApplicationDbContext()
            : base(@"Data Source=ADRI-PC;Initial Catalog=TrainCommander;Integrated Security=True;MultipleActiveResultSets=True;Application Name=EntityFramework", throwIfV1Schema: false)
        {
        }

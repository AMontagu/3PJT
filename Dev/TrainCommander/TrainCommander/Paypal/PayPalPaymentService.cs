...
namespace TrainCommander.Paypal
{
    public static class PayPalPaymentService
    {
        public static Payment CreatePayment(string baseUrl, string intent, double totalPrice)
        {
            // ### Api Context
            ...
            var payment = new Payment()
            {
                ...
                transactions = GetTransactionsList(totalPrice),
        ...
        private static List<Transaction> GetTransactionsList(double totalPrice)
        {
            // A transaction defines the contract of a payment
            // what is the payment for and who is fulfilling it. 
            var transactionList = new List<Transaction>();

            string price = totalPrice.ToString("0.00");
            ...
            // add the created Transaction to a List
                ...
                {
                    description = "Train commander ticket.",
        ...
        {
            var returnUrl = intent == "sale" ? "/Checkout/PaymentSuccessful" : "/Checkout/AuthorizeSuccessful";
            ...
            {
                cancel_url = baseUrl + "/Checkout/PaymentCancelled",
